...
# quantities are Word64 and are kept as u64 with NO i64 cast (DC-MITHRIL-05). Every unknown tag /
...
# (A) FAITHFUL Word64 quantity -- the asset map is u64; NO i64 cast (DC-MITHRIL-05, the i64 ceiling
...
if grep -Eq "as i64|i64::try_from|AssetName, i64" "$MOD"; then
  fail "Stage 2 must NOT cast multi-asset quantities to i64 (DC-MITHRIL-05 faithful Word64)"
fi
